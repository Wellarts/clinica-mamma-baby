...
class ContaReceberPolicy
{
    ...
    {
        return $user->hasPermissionTo('View Conta-Receber');
    }
    ...
    {
        return $user->hasPermissionTo('Create Conta-Receber');
    }
    ...
    {
        return $user->hasPermissionTo('Edit Conta-Receber');
    }
    ...
    {
        return $user->hasPermissionTo('Delete Conta-Receber');
    }
